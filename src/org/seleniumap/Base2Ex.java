...
/*
 * It is nothing but a storage room
 * 
 * Required codes and syntax are created in the base class via method and then its been
 * inherited to the current class through using Extends keyword.
 * All often methods are created and stored in this class.
 * 
 * 
 */

public class Base2Ex {
